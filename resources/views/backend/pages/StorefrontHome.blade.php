        ...
        <main>
            <div class="container">
                            ...
                            <div class="card-body d-flex flex-column justify-content-between" id="menuColumn">
                                <a class="nav-link body-link px-0 py-2" href="Storefront.Categories.html">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13"
                                        ...
                                        class="acorn-icons acorn-icons-chevron-right align-middle float-end mb-1">
                                        <path
                        ...
                        <div class="row g-2 mb-2">
                            <div class="col-12 col-sm-6 col-md-8">
                                <div class="card sh-30 sh-sm-45 hover-img-scale-up">
                                    <img src="{{ asset('/backend/assets/img/banner/cta-standard-1.webp') }}"
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <div class="cta-1 mb-3 text-black w-md-100 w-75">Wall Shelf Ideas to
                            ...
                            <div class="col-12 col-sm-6 col-md-4">
                                <div class="card sh-30 sh-sm-45 hover-img-scale-up">
                                    <img src="{{ asset('/backend/assets/img/banner/cta-vertical-3.webp') }}"
                                        class="card-img h-100 scale" alt="card image" />
                                    <div
                                        class="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
                                        <div>
                                            <div class="cta-1 mb-5 text-black w-md-100 w-75">Sale on Notebooks and
                                                Sketchbooks</div>
                                        </div>
                                        <div>
                                            <a href="Storefront.Filters.html"
                        ...
                        <div class="row g-2">
                            <div class="col-12 col-sm-6">
                                <div class="card sh-22 sh-xl-19 hover-img-scale-up">
                                    ...
                                    <img src="{{ asset('/backend/assets/img/banner/cta-horizontal-short-1.webp') }}"
                                        class="card-img h-100 scale" alt="card image" />
                                    <div
                                        class="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
                                        <div>
                                            <div class="cta-3 mb-2 text-black w-75">10% Discount for Canned Products
                                            </div>
                                        </div>
                                        <div>
                                            <a href="Storefront.Filters.html"
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="card sh-22 sh-xl-19 hover-img-scale-up">
                                    <span
                                        class="badge rounded-pill bg-primary me-1 position-absolute e-2 t-2 z-index-1">SALE</span>
                                    <img src="{{ asset('/backend/assets/img/banner/cta-horizontal-short-2.webp') }}"
                                        class="card-img h-100 scale" alt="card image" />
                                    <div
                                        class="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
                                        <div>
                                            <div class="cta-3 mb-2 text-black w-75">20% Discount for Bagged Products
                                            </div>
                                        </div>
                                        <div>
                                            <a href="Storefront.Filters.html"
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-4 g-2 mb-5">
                    ...
                    <div class="col">
                        <div class="card h-100">
                            <img src="{{ asset('/backend/assets/img/product/small/product-2.webp') }}"
                                class="card-img-top sh-22" alt="card image" />
                            <div class="card-body pb-2">
                                <div class="h6 mb-0 d-flex">
                                    <a href="Storefront.Detail.html" class="body-link d-block lh-1-25 stretched-link">
                    ...
                    <div class="col">
                        <div class="card h-100">
                            <span
                                class="badge rounded-pill bg-primary me-1 position-absolute s-n2 t-2 z-index-1">SALE</span>
                            <img src="{{ asset('/backend/assets/img/product/small/product-3.webp') }}"
                                class="card-img-top sh-22" alt="card image" />
                            <div class="card-body pb-2">
                                <div class="h6 mb-0 d-flex">
                                    <a href="Storefront.Detail.html" class="body-link d-block lh-1-25 stretched-link">
                    ...
                    <div class="col">
                        <div class="card h-100">
                            <img src="{{ asset('/backend/assets/img/product/small/product-4.webp') }}"
                                class="card-img-top sh-22" alt="card image" />
                ...
                <div class="row g-2 row-cols-1 row-cols-md-2 row-cols-xl-2 row-cols-xxl-3 mb-5">
                        ...
                        <div class="card">
                            <div class="row g-0 sh-16 sh-sm-17">
                                <div class="col-auto h-100 position-relative">
                                    ...
                                    <img src="{{ asset('/backend/assets/img/product/small/product-9.webp') }}"
                                        alt="alternate text"
                                    ...
                                    <div class="card-body d-flex align-items-center h-100 py-3">
                                        <div class="mb-0 h6">
                                            <a href="Storefront.Detail.html" class="body-link stretched-link">
                                                <div class="clamp-line sh-3 lh-1-5" data-line="1">XBox Controller
                                                </div>
                                            </a>
                            ...
                            <div class="row g-0 sh-16 sh-sm-17">
                                ...
                                <div class="col p-0">
                                    <div class="card-body d-flex align-items-center h-100 py-3">
                                        <div class="mb-0 h6">
                                            <a href="Storefront.Detail.html" class="body-link stretched-link">
                                                <div class="clamp-line sh-3 lh-1-5" data-line="1">Aromatic Green
                                                    Candle</div>
                                            </a>
                                            <div class="card-text mb-2">
                                                <div class="text-muted text-overline text-small sh-2"></div>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="row g-0 sh-16 sh-sm-17">
                                <div class="col-auto h-100">
                                    <img src="{{ asset('/backend/assets/img/product/small/product-10.webp') }}"
                                        alt="alternate text"
                                        class="card-img card-img-horizontal h-100 sw-11 sw-sm-16 sw-lg-20" />
                                </div>
                                <div class="col p-0">
                                    <div class="card-body d-flex align-items-center h-100 py-3">
                                        <div class="mb-0 h6">
                                            <a href="Storefront.Detail.html" class="body-link stretched-link">
                                                <div class="clamp-line sh-3 lh-1-5" data-line="1">Health and Fitness
                                                    Smartwatch</div>
                                            </a>
                                            <div class="card-text mb-2">
                                                <div class="text-muted text-overline text-small sh-2"></div>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="row g-0 sh-16 sh-sm-17">
                                <div class="col-auto h-100">
                                    <img src="{{ asset('/backend/assets/img/product/small/product-8.webp') }}"
                                        alt="alternate text"
                                        class="card-img card-img-horizontal h-100 sw-11 sw-sm-16 sw-lg-20" />
                                </div>
                                <div class="col p-0">
                                    <div class="card-body d-flex align-items-center h-100 py-3">
                                        <div class="mb-0 h6">
                                            <a href="Storefront.Detail.html" class="body-link stretched-link">
                                                <div class="clamp-line sh-3 lh-1-5" data-line="1">Geometric
                                                    Chandelier</div>
                                            </a>
                                            <div class="card-text mb-2">
                                                <div class="text-muted text-overline text-small sh-2"></div>
                            ...
                            <div class="row g-0 sh-16 sh-sm-17">
                                ...
                                <div class="col p-0">
                                    <div class="card-body d-flex align-items-center h-100 py-3">
                                        <div class="mb-0 h6">
                                            <a href="Storefront.Detail.html" class="body-link stretched-link">
                                                <div class="clamp-line sh-3 lh-1-5" data-line="1">Modern Dark Pot
                                                </div>
                                            </a>
                                            <div class="card-text mb-2">
                                                <div class="text-muted text-overline text-small sh-2">
                        ...
                        <div class="card">
                            <div class="row g-0 sh-16 sh-sm-17">
                                <div class="col-auto h-100 position-relative">
                                    <span
                                        class="badge rounded-pill bg-primary me-1 position-absolute e-n2 t-2 z-index-1">SALE</span>
                                    <img src="{{ asset('/backend/assets/img/product/small/product-5.webp') }}"
                                        alt="alternate text"
                                        class="card-img card-img-horizontal h-100 sw-11 sw-sm-16 sw-lg-20" />
                                </div>
                                <div class="col p-0">
                                    <div class="card-body d-flex align-items-center h-100 py-3">
                                        <div class="mb-0 h6">
                                            <a href="Storefront.Detail.html" class="body-link stretched-link">
                                                <div class="clamp-line sh-3 lh-1-5" data-line="1">Wood Handle Hunter
                                                    Knife</div>
                                            </a>
                                            <div class="card-text mb-2">
                                                <div class="text-muted text-overline text-small sh-2">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div id="categoryMenuMoveContent" data-move-target="#menuColumn"
