...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>Acorn Admin Template | Checkout Page</title>
    <meta name="description" content="Ecommerce Checkout Page" />
    <!-- Favicon Tags Start -->
    <link rel="apple-touch-icon-precomposed" sizes="57x57" href="{{ asset('backend/assets/img/favicon/apple-touch-icon-57x57.png') }}" />
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{ asset('backend/assets/img/favicon/apple-touch-icon-114x114.png') }}" />
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{ asset('backend/assets/img/favicon/apple-touch-icon-72x72.png') }}" />
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ asset('backend/assets/img/favicon/apple-touch-icon-144x144.png') }}" />
    <link rel="apple-touch-icon-precomposed" sizes="60x60" href="{{ asset('backend/assets/img/favicon/apple-touch-icon-60x60.png') }}" />
    <link rel="apple-touch-icon-precomposed" sizes="120x120" href="{{ asset('backend/assets/img/favicon/apple-touch-icon-120x120.png') }}" />
    <link rel="apple-touch-icon-precomposed" sizes="76x76" href="{{ asset('backend/assets/img/favicon/apple-touch-icon-76x76.png') }}" />
    <link rel="apple-touch-icon-precomposed" sizes="152x152" href="{{ asset('backend/assets/img/favicon/apple-touch-icon-152x152.png') }}" />
    <link rel="icon" type="image/png" href="{{ asset('backend/assets/img/favicon/favicon-196x196.png') }}" sizes="196x196" />
    <link rel="icon" type="image/png" href="{{ asset('backend/assets/img/favicon/favicon-96x96.png') }}" sizes="96x96" />
    <link rel="icon" type="image/png" href="{{ asset('backend/assets/img/favicon/favicon-32x32.png') }}" sizes="32x32" />
    <link rel="icon" type="image/png" href="{{ asset('backend/assets/img/favicon/favicon-16x16.png') }}" sizes="16x16" />
    <link rel="icon" type="image/png" href="{{ asset('backend/assets/img/favicon/favicon-128.png') }}" sizes="128x128" />
    ...
    <meta name="msapplication-square150x150logo" content="{{ asset('backend/assets/img/favicon/mstile-150x150.png') }}" />
    <meta name="msapplication-wide310x150logo" content="{{ asset('backend/assets/img/favicon/mstile-310x150.png') }}" />
    <meta name="msapplication-square310x310logo" content="{{ asset('backend/assets/img/favicon/mstile-310x310.png') }}" />
    <!-- Favicon Tags End -->
    <!-- Font Tags Start -->
    ...
    <link rel="stylesheet" href="{{ asset('backend/assets/css/vendor/select2.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('backend/assets/css/vendor/select2-bootstrap4.min.css') }}" />
    <!-- Vendor Styles End -->
 ...
 <script src="{{ asset('backend/assets/js/vendor/select2.full.min.js') }}"></script>
 <script src="{{ asset('backend/assets/js/vendor/timepicker.js') }}"></script>
 <!-- Vendor Scripts End -->
 ...
 <script src="{{ asset('backend/assets/js/pages/storefront.checkout.js') }}"></script>
