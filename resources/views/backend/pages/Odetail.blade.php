                    ...
                    <div class="col-12">
                      <div class="mb-5">
                        <div class="row g-0 sh-9 mb-3">
                          <div class="col-auto">
                            <img src="{{asset('/backend/assets/img/product/small/product-9.webp')}}" class="card-img rounded-md h-100 sw-13" alt="thumb" />
                          </div>
                          <div class="col">
                        ...
                        <div class="row g-0 sh-9 mb-3">
                          <div class="col-auto">
                            <img src="{{asset('/backend/assets/img/product/small/product-8.webp')}}" class="card-img rounded-md h-100 sw-13" alt="thumb" />
                          </div>
                          <div class="col">
                            <div class="ps-4 pt-0 pb-0 pe-0 h-100">
                              <div class="row g-0 h-100 align-items-start align-content-center">
                        ...
                        <div class="row g-0 sh-9 mb-3">
                          <div class="col-auto">
                            <img src="{{asset('/backend/assets/img/product/small/product-2.webp')}}" class="card-img rounded-md h-100 sw-13" alt="thumb" />
                          </div>
                          <div class="col">
                            <div class="ps-4 pt-0 pb-0 pe-0 h-100">
                              <div class="row g-0 h-100 align-items-start align-content-center">
                        ...
                        <div class="row g-0 sh-9 mb-3">
                          <div class="col-auto">
                            <img src="{{asset('/backend/assets/img/product/small/product-1.webp')}}" class="card-img rounded-md h-100 sw-13" alt="thumb" />
                          </div>
                          <div class="col">
                            <div class="ps-4 pt-0 pb-0 pe-0 h-100">
                              <div class="row g-0 h-100 align-items-start align-content-center">
                        ...
                        <div class="row g-0 sh-9 mb-3">
                          <div class="col-auto">
                            <img src="{{asset('/backend/assets/img/product/small/product-3.webp')}}" class="card-img rounded-md h-100 sw-13" alt="thumb" />
                          </div>
                          <div class="col">
                            <div class="ps-4 pt-0 pb-0 pe-0 h-100">
                              <div class="row g-0 h-100 align-items-start align-content-center">
                        ...
                        <div class="row g-0 sh-9 mb-3">
                          <div class="col-auto">
                            <img src="{{asset('/backend/assets/img/product/small/product-6.webp')}}" class="card-img rounded-md h-100 sw-13" alt="thumb" />
                          </div>
                          <div class="col">
                            <div class="ps-4 pt-0 pb-0 pe-0 h-100">
                              <div class="row g-0 h-100 align-items-start align-content-center">
