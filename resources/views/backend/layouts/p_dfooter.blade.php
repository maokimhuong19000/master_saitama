...
<script src="{{ asset('backend/assets/js/vendor/imask.js') }}"></script>

<script src="{{ asset('backend/assets/js/vendor/quill.min.js') }}"></script>

<script src="{{ asset('backend/assets/js/vendor/quill.active.js') }}"></script>

<script src="{{ asset('backend/assets/js/vendor/select2.full.min.js') }}"></script>

<script src="{{ asset('backend/assets/js/vendor/tagify.min.js') }}"></script>
...
<script src="{{ asset('backend/assets/js/cs/dropzone.templates.js') }}"></script>
<script src="{{ asset('backend/assets/js/pages/products.detail.js') }}"></script>
