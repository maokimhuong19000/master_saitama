 ...
 <script src="{{ asset('backend/assets/js/vendor/movecontent.js') }}"></script>
 <!-- Vendor Scripts End -->
 ...
 <script src="{{ asset('backend/assets/js/cs/checkall.js') }}"></script>
 <script src="{{ asset('backend/assets/js/pages/storefront.filters.js') }}"></script>
