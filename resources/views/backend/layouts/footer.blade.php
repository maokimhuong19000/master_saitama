    ...
    <script src="{{asset('/backend/assets/js/vendor/Chart.bundle.min.js')}}"></script>
    <script src="{{asset('/backend/assets/js/vendor/chartjs-plugin-rounded-bar.min.js')}}"></script>
    <script src="{{asset('/backend/assets/js/vendor/jquery.barrating.min.js')}}"></script>
    <!-- Vendor Scripts End -->
    ...
    {{-- <script src="{{asset('/backend/assets/js/base/search.json')}}"></script> --}}
    <script src="{{asset('/backend/assets/js/base/settings.js')}}"></script>
    <!-- Template Base Scripts End -->
    <!-- Page Specific Scripts Start -->
    <script src="{{asset('/backend/assets/js/cs/charts.extend.js')}}"></script>
